...
public class ClassInfo extends BinaryInfo {
	...
	if (version < (45 << 16 | 0)
//          I believe this part of the test makes Jode barf on JDK1.4, and if
//          I just up it enough for JDK1.4, will make it barf when the next
//          JDK version comes out. So I've omitted this test entirely.
//          The worry, of course, is that perhaps the format has actually
//          changed enough for Jode not to understand it - I'm not sure whether
//          the language changes (assert etc) are enough to break Jode...
//                                            -- sballard, 2002/11/21
//	    || version > (47 << 16 | 0))
           )
	  throw new ClassFormatException("Wrong class version "+(version>>16));
